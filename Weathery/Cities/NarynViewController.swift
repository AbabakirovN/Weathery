...
class NarynViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
               ...
               let leftSwipe = UISwipeGestureRecognizer(target: self, action: #selector(swipeAction(swipe:)))
                ...
                guard let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?lat=41.42743&lon=75.9841&APPID=3331e666239ea2e7435b26c22893307c")else { return }
