...
class IssykKolViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        guard let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?lat=42.6503&lon=77.0852&APPID=3331e666239ea2e7435b26c22893307c")else { return }
