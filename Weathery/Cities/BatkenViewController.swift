//
//  BatkenViewController.swift
//  Weathery
//
//  Created by Nurzhan Ababakirov on 11/20/19.
//  Copyright © 2019 Nurzhan Ababakirov. All rights reserved.
//

import UIKit

class BatkenViewController: UIViewController {
    ...
    override func viewDidLoad() {
          super.viewDidLoad()
           ...
           let leftSwipe = UISwipeGestureRecognizer(target: self, action: #selector(swipeAction(swipe:)))
            ...
            guard let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?lat=40.0548&lon=70.8209&APPID=3331e666239ea2e7435b26c22893307c")else { return }
